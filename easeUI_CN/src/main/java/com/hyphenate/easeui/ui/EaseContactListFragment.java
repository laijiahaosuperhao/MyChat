...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    protected void getContactList() {
        Log.d("map", String.valueOf(contactsMap)+666);
        contactList.clear();
        Log.d("map", String.valueOf(contactsMap)+555);
        if(contactsMap == null){
            Log.d("map", String.valueOf(contactsMap)+333);
            return;
        }
        synchronized (this.contactsMap) {
            Log.d("map", String.valueOf(contactsMap)+444);
    ...
    public void setContactsMap(Map<String, EaseUser> contactsMap){
        Log.d("map", String.valueOf(contactsMap)+111);
        this.contactsMap = contactsMap;
        Log.d("map", String.valueOf(contactsMap)+222);
    }
