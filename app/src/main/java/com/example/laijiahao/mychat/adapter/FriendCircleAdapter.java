...
import com.example.laijiahao.mychat.utils.ScreenTools;
import com.example.laijiahao.mychat.widget.CustomImageView;
import com.example.laijiahao.mychat.widget.Image;
import com.example.laijiahao.mychat.widget.NineGridlayout;
...
public class FriendCircleAdapter extends BaseAdapter {
    ...
    public FriendCircleAdapter(Context context, List<List<Image>> datalist) {
